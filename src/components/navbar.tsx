      ...
      <div className="container flex h-16 items-center">
        <div className="mr-6 flex items-center">
          <Link className="mr-6 flex items-center space-x-2" href="/">
            <span className="font-bold sm:inline-block">Trợ Lý Bếp</span>
          </Link>
          
          {/* Thêm link Khám phá vào đây, hiển thị cho tất cả mọi người */}
          <nav className="hidden md:flex items-center space-x-8 text-sm font-medium">
            <Link href="/explore" className="transition-colors hover:text-foreground/80 text-foreground">Khám phá</Link>
            {accessToken && (
              <>
        ...
        <div className="flex flex-1 items-center justify-end space-x-4">
          ...
          {accessToken ? (
            <>
              ...
              <Link href="/recipes/new"><Button size="sm">Viết công thức</Button></Link>
